...
class SpecialRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create special_request" do
    assert_difference("SpecialRequest.count") do
      post special_requests_url, params: { special_request: { booking_id: @special_request.booking_id, price: @special_request.price, request: @special_request.request, reservation_id: @special_request.reservation_id } }
    end
  ...
  test "should update special_request" do
    patch special_request_url(@special_request), params: { special_request: { booking_id: @special_request.booking_id, price: @special_request.price, request: @special_request.request, reservation_id: @special_request.reservation_id } }
