...
ActiveRecord::Schema[8.0].define(version: 2025_03_23_082302) do
  ...
  create_table "booking_additional_services", force: :cascade do |t|
    ...
    t.index ["booking_id"], name: "index_booking_additional_services_on_booking_id"
  end
  ...
  create_table "room_reservations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["booking_id"], name: "index_room_reservations_on_booking_id"
  ...
  create_table "special_requests", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["booking_id"], name: "index_special_requests_on_booking_id"
    t.index ["room_reservation_id"], name: "index_special_requests_on_room_reservation_id"
  end
  ...
  create_table "vip_customers_benefits", force: :cascade do |t|
    t.integer "customer_id"
    t.integer "discount_type"
    t.integer "discount_percent_on_room_price"
    t.integer "discount_percent_on_additional_services"
