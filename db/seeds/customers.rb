...
customers = [
  { name: "John Doe", email: "johndoe@example.com", encrypted_password: encrypted_password, phone_number: "1234567890", address: "1234 Sunset Blvd, Los Angeles, CA, USA", note: "VIP customer", customer_type: 1 },
  { name: "Jane Smith", email: "janesmith@example.com", encrypted_password: encrypted_password, phone_number: "0987654321", address: "5678 Oakwood Dr, Dallas, TX, USA", note: "Regular customer", customer_type: 0 },
  ...
  { name: "Michael Brown", email: "michaelbrown@example.com", encrypted_password: encrypted_password, phone_number: "1234567891", address: "1213 Birch Ln, Denver, CO, USA", note: "VIP customer", customer_type: 1 },
  { name: "Emily Davis", email: "emilydavis@example.com", encrypted_password: encrypted_password, phone_number: "0987654322", address: "1415 Pinecrest Rd, Miami, FL, USA", note: "Regular customer", customer_type: 0 },
  ...
  { name: "Benjamin Lee", email: "benjaminlee@example.com", encrypted_password: encrypted_password, phone_number: "3344556677", address: "2021 Willow Way, Boston, MA, USA", note: "VIP customer", customer_type: 1 },
  { name: "Olivia Harris", email: "oliviaharris@example.com", encrypted_password: encrypted_password, phone_number: "4455667788", address: "2223 River Rd, Portland, OR, USA", note: "Regular customer", customer_type: 0 },
  ...
  { name: "David King", email: "davidking@example.com", encrypted_password: encrypted_password, phone_number: "9900112233", address: "1213 Birch Ln, Denver, CO, USA", note: "VIP customer", customer_type: 1 },
  { name: "Ava Scott", email: "avascott@example.com", encrypted_password: encrypted_password, phone_number: "1122334457", address: "1415 Pinecrest Rd, Miami, FL, USA", note: "Regular customer", customer_type: 0 },
  ...
  { name: "Mia Robinson", email: "miarobinson@example.com", encrypted_password: encrypted_password, phone_number: "7788990012", address: "1234 Sunset Blvd, Los Angeles, CA, USA", note: "Regular customer", customer_type: 0 }
]
