class Init < ActiveRecord::Migration[8.0]
  def change
    ...
    # Vip Customers Benefits table
    create_table :vip_customers_benefits do |t|
    ...
    add_index :vip_customers_benefits, :customer_id
    ...
    add_index :room_reservations, :booking_id
    ...
    add_index :special_requests, :booking_id
    add_index :special_requests, :room_reservation_id
    ...
    add_index :booking_additional_services, :booking_id
